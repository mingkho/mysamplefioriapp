		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#mysamplefioriapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mysamplefioriapp-display": {
								"semanticObject": "mysamplefioriapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mysamplefioriapp",
									"url": sap.ui.require.toUrl("mysamplefioriapp")
								}
							}
						}
					}
